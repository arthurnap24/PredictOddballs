...
int main()
{
  ...
  // For this application, use the Internet address family, streaming sockets,
  // and
  // the TCP/IP protocol.
  ...
  // Create a continuous loop that checks for connections requests. If a
  // connection
  ...
  while (1)
  {
    ...
    // When the client connection has been accepted, transfer control
    // from the
